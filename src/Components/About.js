  ...
  return (
    <div className="about-section-container" style={{ marginTop: '8vh' }}>
      ...
      <div className="about-section-text-container" style={{ lineHeight: '1.5' }}>
        ...
        <p className="primary-text">- Since 2021</p>
        {/* <p className="primary-text">- Anna university recogonized Research centre</p> */}
        <p className="primary-text">- Strong Industrial collaboration and PEP and POP training for placements</p>
        ...
        <div className="about-buttons-container">
          <a href="http://sjceads.com/demo-1/index.html"
            target="_blank"
            style={{
              color: "white",
              textDecoration: "none",
