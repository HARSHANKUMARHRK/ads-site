...
const Home = () => {
  const staticContent = [
    {
      heading: "Department <br/>Artificial Intelligence &<br/>Data Science Offers a summer internship by the best professionals. &<br/> From 15th April to 24th May",
      text: [
        "Courses Offered",
        "- Web Development",
        "- UI/UX",
      ...
      link: "https://forms.gle/uPEJtVVy3yY3Lq6Q9",
  ...
  return (
    ...
    >
      ...
      >
        ...
        backgroundClip: 'text',
        WebkitTextFillColor: 'transparent',fontSize: '3vh' }}>
          From 6th April to 10th May <br /></h3>
